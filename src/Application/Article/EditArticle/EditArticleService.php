...
class EditArticleService
{
    ...
    public function execute(string $id, string $name, string $description, string $image, bool $isActive, string $endDate, int $currentPrice, int $directBidPrice1, int $directBidPrice2, int $directBidPrice3)
    {
